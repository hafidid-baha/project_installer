...
use hafid\project_installer\http\Controllers\InstallController;
use Illuminate\Support\Facades\Route;

Route::group(['middleware' => 'installer', 'namespace' => 'hafid\project_installer\http\Controllers'], function () {
